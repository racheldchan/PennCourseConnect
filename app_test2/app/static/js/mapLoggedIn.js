  ...
  var pos = 
	...
	var contentString =
		"<div id='content'>"+
			...
			"<div id='bodyContent'>"+
				"<img border='0' align:'left' src='./static/img/profileSahil.png'>"+
	...
	/*var contentString = '<div id="content">'+
		...
		'<p><b>Currently Working On:</b> <input type="text" placholder="cis350">'+
		'<p><b>Currently In Room:</b> Moore 100A'+
		'<p><b>Having Difficulty With:</b> Final Project'+ '<br>'  + 
		'<input id="request-button" type="button" onclick="getUpdates();" value="Send Request"></input>' +
		'</div>'+
		'</div>';*/
